...
Each generated password includes a copy button with success/failure feedback. A Regenerate button refreshes the full list and updates the status message.
